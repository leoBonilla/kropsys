<div class="col-md-12">
	...
	<div class="form-group col-md-3" >
		<label for="erroneos">SIN CUPO</label>
		<input type="text" class="form-control numbersOnly" name="sin_cupo" value="<?php echo $registro->sin_cupo; ?>" required="required">
	</div>
    ...
    <div class="row">
    	 <div class="form-group col-md-12">
      	...
      	<a href="<?php echo base_url('registros/reasignaciones'); ?>" class="btn btn-danger"><i class="fa fa-arrow-left"></i> Volver</a> </div>

    </div>
      <input type="hidden" name="tipo" value="reasignaciones">
